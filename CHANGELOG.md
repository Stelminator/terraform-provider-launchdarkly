...
- The `launchdarkly_feature_flag_environment` data source now checks whether the environment exists and prints out a more descriptive error. [#101](https://github.com/stelminator/terraform-provider-launchdarkly/v2/issues/101)
...
- Added Slack webhooks to the `launchdarkly_audit_log_subscription` resource and data source. [#16](https://github.com/stelminator/terraform-provider-launchdarkly/v2/issues/16)
...
- Fixed a [bug](https://github.com/stelminator/terraform-provider-launchdarkly/v2/issues/79) introduced in v2.2.0 where `launchdarkly_segments` with `rule` blocks not containing a `weight` were defaulting to a `weight` of 0.
...
- Fixes [a bug](https://github.com/stelminator/terraform-provider-launchdarkly/v2/issues/60) where attempts to create `launchdarkly_feature_flag` variations with an empty string value were throwing a panic.
...
- Fixed a bug where omitted optional `launchdarkly_feature_flag_environment` parameters where making unwanted changes
  to the resource upon creation. [#38](https://github.com/stelminator/terraform-provider-launchdarkly/v2/issues/38)
...
- Point `go.mod` to github.com/stelminator/terraform-provider-launchdarkly/v2
...
- Handle missing user target variations in `launchdarkly_feature_flag_environment` [#23](https://github.com/stelminator/terraform-provider-launchdarkly/v2/issues/23)

## [1.2.1] (April 14, 2020)

BUG_FIXES:

- Fix import bug in `launchdarkly_project` introduced in 1.2.0 [#21](https://github.com/stelminator/terraform-provider-launchdarkly/v2/issues/21)
...
- Add `policy_statements` to `launchdarkly_webhook` and `launchdarkly_custom_role` [#16](https://github.com/stelminator/terraform-provider-launchdarkly/v2/issues/16).

BUG_FIXES:

- Fixed bug preventing large number variations from being saved in the state correctly. [#14](https://github.com/stelminator/terraform-provider-launchdarkly/v2/issues/14)
- Fixed bug in import validation. [#19](https://github.com/stelminator/terraform-provider-launchdarkly/v2/issues/19)
...
- Add tags attribute to `launchdarkly_environment` resource. [#5](https://github.com/stelminator/terraform-provider-launchdarkly/v2/issues/5)
...
- Allow flag `maintainer_id` to be unset. [#6](https://github.com/stelminator/terraform-provider-launchdarkly/v2/issues/6)
